package com.wxk.timeconsuminglib.loadingdialog.view;
...
import com.wxk.timeconsuminglib.R;
import com.wxk.timeconsuminglib.loadingdialog.manager.StyleManager;
...
public class LoadingDialog implements FinishDrawListener {
     ...
     * @return 这个对象
     */
    public LoadingDialog setLoadingSpannedText(Spanned msg) {
        loadingText.setText(msg);
        return this;
    }
